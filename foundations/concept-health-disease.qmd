...
| Model | Core idea |
|---|---|
| **Biomedical** | Health = absence of disease; rooted in germ theory. Criticized for ignoring social, environmental, and psychological determinants |
...
## Positive Health and Wellness {background-color="#E8E4F3"}
